...
public class MoreActivity extends AppCompatActivity {
    ...
    final String[] mManyWords = {"Hello", "I", "am", "your", "friend", "Steven"};
    ...
    // 设置映射函数
    private Func1<List<String>, Observable<String>> mOneLetterFunc = new Func1<List<String>,
            Observable<String>>() {
        @Override
...
//                .map(mUpperLetterFunc).subscribe(mToastAction);
    ...
    private String sayMyName() {
        return "Hello, I am your friend, Steven!";
    }
}
